...
const T = {
  es: {
    ...
    cameraWebTitle: "Cámara no disponible en navegador",
    cameraWebSubtitle: "Para usar la cámara, abre la app en tu móvil con Expo Go o usa 'Subir foto' para seleccionar desde la galería.",
    cameraNeedsPermission: "Se necesita acceso a la cámara",
    cameraNeedsPermissionDesc: "Para tomar fotos de pasaporte necesitamos acceder a tu cámara.",
    cameraAllow: "Permitir acceso",
    cameraGuideHint: "Ojos en la línea amarilla · Cabeza erguida · Fondo neutro",
    eyeLineLabel: "OJOS",
    cameraCenterFace: "Centra tu cara en el óvalo",
    checkFaceVisible: "Rostro visible",
    checkDistance: "Distancia correcta",
    checkHeadStraight: "Cabeza recta",
    checkCentered: "Centrado",
    serverBusy: "El servidor está ocupado, reintentando...",
    galleryLabel: "Galería",
    photoAccessTitle: "Acceso a Fotos",
    photoAccessNeeded: "Se necesita permiso para acceder a tu galería.",
    photoAccessSettings: "Activa el acceso a fotos en Ajustes > PassPic PRO para continuar.",
  ...
  en: {
    ...
    cameraWebTitle: "Camera not available in browser",
    cameraWebSubtitle: "To use the camera, open the app on your mobile with Expo Go or use 'Upload Photo' to select from your gallery.",
    cameraNeedsPermission: "Camera access required",
    cameraNeedsPermissionDesc: "To take passport photos, we need access to your camera.",
    cameraAllow: "Allow access",
    cameraGuideHint: "Eyes on yellow line · Head straight · Neutral background",
    eyeLineLabel: "EYES",
    cameraCenterFace: "Center your face in the oval",
    checkFaceVisible: "Face visible",
    checkDistance: "Correct distance",
    checkHeadStraight: "Head straight",
    checkCentered: "Centered",
    serverBusy: "Server is busy, retrying...",
    galleryLabel: "Gallery",
    photoAccessTitle: "Photo Access",
    photoAccessNeeded: "Permission needed to access your gallery.",
    photoAccessSettings: "Enable photo access in Settings > PassPic PRO to continue.",
